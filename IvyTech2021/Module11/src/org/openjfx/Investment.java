package org.openjfx;
	 ...
	 * Date: 11/14/2021
	 * Summary: This displays a GUI to fill out to get the future value
	 */
	...
	public class Investment extends Application {
		...
		@Override //Uses this as the start method by overriding it.
		public void start(Stage primaryStage) {
			...
			//This creates where everything goes
			...
			// calculates the future investment
			btCalculate.setOnAction(e -> futureValue());

			// Sets the title and scene
			Scene scene = new Scene(pane);
			primaryStage.setTitle("Investment"); // Set the stage title
